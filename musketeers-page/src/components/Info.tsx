    ...
    <>
      ...
      <div className='body'>
        ...
        <div>
          ...
          <div className='answers'>
            <p>
              <b className='bold'>Absolutely not!</b> MFS fencers have a diverse range of skill level, from top Canadian fencers to first timers. You will be part of a club which pays attention to skill level, and helps you develop at your own pace.
            </p>
