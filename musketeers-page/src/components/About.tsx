        ...
        <div className="spacing">
          ...
          <div className='layout'>
            ...
            <div>
              ...
              <div>
                <p className='indent'>Fencing is a <b>"blink-of-an-eye and you'll miss it" </b>sport that simulates sword duels. Bouts are between two fencers; they are restricted to a strip that is one-and-a-half to two meters wide and fourteen meters long, and all movement is forward or back. The target area for valid hits depends on the specific weapon used.
                  Fencing has a blend of patience, competitiveness and discipline. However, the <b>respect between fencers</b> is the primary characteristic to attain and understand.</p>
                <h4>Fencing can attributed as the following:</h4>
                <p>Physically, fencing is comparable to a game of squash. It involves speed, accuracy and endurance.<br />
